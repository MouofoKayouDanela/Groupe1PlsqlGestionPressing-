...
PROMPT                               A - retour
ACCEPT mon_choix CHAR PROMPT 'Veuillez entrer le caractere correspondant z votre choix : '
...
SELECT CASE '&mon_choix'
            WHEN 'A' THEN 'Objets/Fonctionnalite/SQLPLUS/Agence/Consultation/EX_ListeAgence'
